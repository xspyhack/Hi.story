...
protocol MemoriesCardViewModelType {
    var text: String { get }
    var date: String { get }
    var imageURL: URL? { get }
    var avatar: URL? { get }
}
struct MemoriesCardViewModel: MemoriesCardViewModelType {
    let text: String
    let date: String
    let imageURL: URL?
    let avatar: URL?
...
final class MemoriesCardView: TodayCardView, Configurable {
    ...
    func configure(withPresenter presenter: MemoriesCardViewModelType) {
